defmodule DiscordCloneWeb.CoreComponents do
  @moduledoc """
...
# ModeToggle Component (simple example)
def mode_toggle(assigns) do
  ~H"""
  <button phx-click="toggle_mode" class="p-2 rounded-full bg-gray-200 dark:bg-gray-700">

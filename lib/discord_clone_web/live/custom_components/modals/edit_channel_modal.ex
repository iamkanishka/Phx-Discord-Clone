defmodule DiscordCloneWeb.CustomComponents.Modals.EditChannelModal do
  ...
  def render(assigns) do
    ...
    <div class="bg-white text-black p-0 overflow-hidden">
      <.header class="pt-8 px-6">
        <span class="text-2xl text-center font-bold"> Edit Channel </span>
      </.header>
      ...
      >
        ...
        <:actions>
          <div class="bg-gray-100 px-6 py-4">
            <.button disabled={@isLoading} phx-disable-with="Creating...">Save</.button>
          </div>
        </:actions>
      </.simple_form>
    </div>
